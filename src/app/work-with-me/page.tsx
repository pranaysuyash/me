...
const engagements = [
  ...
  },
  {
    ...
    body: 'A short working sprint for teams that need sharper decisions on scope, workflow risk, and practical implementation direction before committing to a bigger build.',
    bestFit:
      'A team has real operational pain but needs a better first-build plan and decision clarity before execution.',
...
const buyerProof = [
  ...
  },
  {
    ...
    detail:
      'Built production extraction handling highly variable semantic structures across heterogeneous document formats.',
    shape:
        ...
        <div className='container max-w-[1280px] mx-auto px-4 md:px-6 lg:px-8'>
          <div className='max-w-3xl animate-fade-up'>
            ...
            <p className='text-lg text-muted-foreground mb-8 leading-relaxed'>
              I work on focused builds where a messy workflow needs to become a
              useful system quickly: clear scope, operational fit, and visible
              outcomes in weeks.
            </p>
          ...
          <Card className='border bg-muted/30'>
            <CardContent className='p-7 md:p-8'>
              ...
              <p className='text-sm text-muted-foreground leading-relaxed mb-6'>
                ...
                but the right first build is still unclear, that can still be
                the starting point. The goal is to reduce ambiguity into a
                realistic first version, not force the problem into the wrong
                package.
              </p>
