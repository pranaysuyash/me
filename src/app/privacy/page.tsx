        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p>
                Hosting and service providers may also process basic technical data such
                as IP address, browser type, device information, timestamps, security
        ...
        },
        {
          ...
          content: (
            <ul className="list-disc space-y-2 pl-6">
              ...
              <li>To comply with applicable legal, accounting, tax, and regulatory obligations.</li>
            </ul>
          ),
        },
        {
          ...
          content: (
            <>
              <p>
                ...
                specific purposes. These may include Cloudflare for hosting and security,
                FormBold for contact-form delivery, Cal.com for scheduling, and Dodo
                Payments for checkout, payment processing, taxes, receipts, refunds, and
                digital-product fulfilment where enabled.
              </p>
              <p>
          ...
          content: (
            <>
              <p>
                ...
                directly by the site, subject to legal and record-keeping requirements.
                You may also object to or restrict certain processing where applicable.
              </p>
              <p>
          ...
          content: (
            <>
              <p>
                ...
                own. By using the site, you understand that information may be transferred
                and processed where those providers operate, subject to applicable law.
              </p>
              <p>
                This policy may be updated when the site, providers, products, or legal
                obligations change. The current version and update date will remain
