        ...
        <div className='container max-w-[1280px] mx-auto px-4 md:px-6 lg:px-8'>
          <div className='max-w-3xl animate-fade-up'>
            ...
            <p className='text-sm text-muted-foreground mb-8 leading-relaxed max-w-2xl'>
              14 years across product delivery and system execution. Most
              recently at MedPiper (YC S20), shipping workflow-heavy systems and
              practical AI features in regulated healthcare operations.
            </p>
      ...
      <section className='py-16'>
        <div className='container max-w-[1280px] mx-auto px-4 md:px-6 lg:px-8'>
          ...
          <p className='text-sm text-muted-foreground mb-6 max-w-2xl'>
            The same flagship proofs used across the site: platform breadth,
            commercial validation, systems depth, and local-first multimodal
            product thinking.
          </p>
