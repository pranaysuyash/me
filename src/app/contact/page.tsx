...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setStatus("success");
      setFormData({ name: "", email: "", company: "", message: "", budget: "", honeypot: "" });
    } catch (error) {
      setStatus("error");
        ...
        <div className="container max-w-3xl mx-auto px-4 md:px-6 lg:px-8">
          ...
          {activeTab === "call" ? (
            <div className="border rounded-xl p-8">
              <h2 className="text-xl font-semibold mb-3">Book a 15-minute call</h2>
            ...
            <form onSubmit={handleSubmit} className="border rounded-xl p-8 space-y-5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  <label htmlFor="project-email" className="block text-sm font-medium mb-1.5">
              ...
              <div>
                <label htmlFor="project-message" className="block text-sm font-medium mb-1.5">
                  Tell me about your project <span className="text-destructive">*</span>
                </label>
                <Textarea
                  id="project-message"
                  name="message"
          ...
          <div className="mt-12 border rounded-xl p-6">
            ...
            <div className="flex flex-wrap gap-6 items-center">
              <div className="flex items-center gap-2 text-sm">
                ...
                <a href="mailto:pranay.suyash@gmail.com" className="text-muted-foreground hover:text-primary transition-colors">
                  pranay.suyash@gmail.com
                </a>
              </div>
              <div className="flex items-center gap-2 text-sm">
              ...
              <div className="flex gap-3">
                <Link href="https://github.com/pranaysuyash" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors">
                  <Github className="h-5 w-5" />
                </Link>
                <Link href="https://linkedin.com/in/pranaysuyash" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors">
