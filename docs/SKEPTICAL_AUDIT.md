...
- **Performance Histograms:** You claim "sub-second retrieval" for PhotoSearch. A skeptic asks: _At what N?_ Retrieval over 1,000 images is easy; retrieval over 1,000,000 images on a mid-range Android device is an engineering feat. The "N" is missing.
