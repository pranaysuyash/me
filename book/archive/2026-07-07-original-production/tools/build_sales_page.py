...
<body>
  <main>
    <div class="hero">
      ...
      <img class="cover" src="../assets/cover/no-claim-without-evidence-cover-candidate-1.png" alt="No Claim Without Evidence ebook cover">
    </div>
    ...
    <section id="buy">
      <div class="section-inner">
        ...
        <p>Upload the PDF and EPUB to Gumroad, Lemon Squeezy, Stripe Payment Link, or your own site, then replace this section with the checkout link.</p>
        <div class="cta-row">
