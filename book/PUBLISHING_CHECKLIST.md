...
- [x] 28,712 tokenized manuscript words.
...
- [x] PDF is 184 pages at 6x9-inch trim with embedded fonts and 23 bookmarks.
...
- Description: `A practical 19-chapter field guide to evidence-linked AI outputs, eval contracts, routing, human review, observability, agent action tests, and release gates. Includes the 184-page PDF and reflowable EPUB.`
